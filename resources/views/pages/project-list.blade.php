...
{{--            <div class="mt-5 grid grid-cols-1 auto-rows-fr md:grid-cols-3 gap-2.5 md:gap-3.75 lg:gap-5" >--}}
{{--                @foreach([--}}
...
{{--                @endforeach--}}
{{--            </div>--}}
{{--            <div class="border-b border-neutral-200 my-10"></div>--}}

            <div class="mt-15" x-data="{ filterTag: new URL(location.href).searchParams.get('tag') || '' }">
