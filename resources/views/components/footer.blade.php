@props(['variant' => ''])
<footer class="pt-12.5 md:pt-20 pb-2.5 {{
    match($variant) {
        'full-dark' => 'bg-eggplant',
        default => '',
    }
}}">
    <div class="container">
        <div class="grid grid-cols-[auto_1fr] gap-y-6 gap-x-5 min-[23rem]:gap-x-10 md:gap-x-17.5 lg:gap-x-37.5 justify-between rounded-2xl content-center items-center px-5 min-[23rem]:px-7.5 md:px-12.5 lg:pl-20 lg:pr-37.5 bg-eggplant border border-white/20 md:min-h-53.25 py-7.5">
