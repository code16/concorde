...
<div class="contents" :data-stuck-top="stuckTop" x-data="{ stuckTop: false }">
        ...
        <div class="relative">
            <div class="flex items-center gap-x-6 h-21.5 px-5 py-4 md:px-10">
                <div class="flex-1 flex">
                    <a class="relative block transition duration-300 origin-left lg:@stuck-top:scale-75 lg:in-data-stuck-top:scale-75" href="{{ route('home') }}">
