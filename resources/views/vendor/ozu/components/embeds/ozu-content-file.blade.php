...
@if(str_starts_with($media->mime_type, 'video/'))
    <div class="mb-14 md:mb-18 -mx-7.5 md:mx-0 flex flex-col items-center">
        <figure class="md:rounded-2xl md:p-2 md:bg-neutral-50 md:border border-neutral-200"
            ...
            <video class="max-w-full object-cover max-h-100 lg:max-h-128 border md:rounded-xl overflow-hidden border-neutral-200" autoplay playsinline loop muted x-init="imgWidth = $width" x-resize="imgWidth = $width">
